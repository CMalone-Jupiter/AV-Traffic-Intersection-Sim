...
CROSS_SPEEDING_CHANCE = 0.20
CROSS_SPEED_GAUSSIAN = 0.5
...
LOWER_CONFLICT_ZONE = (WIDTH//2-LANE_WIDTH//2, WIDTH//2+LANE_WIDTH//2, HEIGHT//2, HEIGHT//2+LANE_WIDTH)
UPPER_CONFLICT_ZONE = (WIDTH//2-LANE_WIDTH//2, WIDTH//2+LANE_WIDTH//2, HEIGHT//2-LANE_WIDTH, HEIGHT//2)
...
YELLOW = (255, 255, 0)
ORANGE = (255, 165, 0)
DARK_ORANGE = (183, 65, 14) #(204, 85, 0) #(255, 100, 0)
GRAY = (150, 150, 150)
BLACK = (0,0,0)
